	...
	public class VerifyRegistration implements commandAction {
		...
		public HashMap<String, Object> requestPro(HttpServletRequest request, HttpServletResponse response)
			...
			try{
				...
				enumMailKind kind = enumMailKind.JOIN;
				for(enumMailKind k : enumMailKind.values()){
				...
				switch(kind){
					...
					case JOIN:
						...
						if (ManageMember.certificateJoin(request.getRequestedSessionId(), email, planeUUID)) {
