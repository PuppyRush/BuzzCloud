...
<%
	...
	enumPage to = enumPage.ENTRY;
 	boolean isFailVerify;
 	Member member = Member.getMember(session.getId());
	HashMap<String,Object> results =  VerifyPage.Verify(session.getId(), enumPage.ENTRY);
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form class="form col-md-12 center-block" id="loginForm"	method="GET" ACTION="login.do">
							<div class="form-group">
								<input type="text" name="email"	 id="email"		class="form-control input-lg" placeholder="Email">
							</div>
							<div class="form-group">
							...
							<input type="hidden"  id="_idType" name="idType" value="nothing">
